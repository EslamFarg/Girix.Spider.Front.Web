...
export class AccountsTree extends BaseComponent {
    ...
    filterOptions: MenuItem[] = [
        {
            label: 'الاسم',
            value: FinancialAccountSearchEnum.Name,
        },
        {
            label: 'رقم الحساب',
            value: FinancialAccountSearchEnum.FinNumber,
        },
    ];
        ...
        return accounts
            .map((account) => {
                ...
                const searchableValue =
                    searchEnum === FinancialAccountSearchEnum.FinNumber ? account.finNumber : account.name;
