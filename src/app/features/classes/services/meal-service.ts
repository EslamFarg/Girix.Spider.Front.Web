...
export class MealService extends SearchableMixin(
  BaseCrudService<IMealCreateRequest, IMealUpdateRequest, IMealReadResponse>,
)<IMealSearchResponseValue, MealSearchEnum>() {
