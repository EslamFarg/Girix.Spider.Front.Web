...
@Component({
  selector: 'app-add-delivery-goods',
  imports: [PageHeader, NgSelectComponent, DatePicker],
  templateUrl: './add-delivery-goods.html',
  styleUrl: './add-delivery-goods.scss',
})
export class AddDeliveryGoods {
...
explorerBtn={
  label:'مستكشف سندات تسليم البضائع ',
  link:'/delivery-goods/explorer'
}
