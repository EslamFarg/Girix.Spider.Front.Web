...
@Component({
  selector: 'app-explorer-quick-sales-point-cashiers',
  imports: [Paginator, PageHeaderSearch],
  templateUrl: './explorer-quick-sales-point-cashiers.html',
  styleUrl: './explorer-quick-sales-point-cashiers.scss',
})
export class ExplorerQuickSalesPointCashiers {
   //!!!!!!!!!! Property 
  dataAddButton={
      label:'اضافه فاتورة مبيعات',
      action:'/quick-sales-point-cashiers/add'
   }
     first: number = 0;
   rows: number = 10;
