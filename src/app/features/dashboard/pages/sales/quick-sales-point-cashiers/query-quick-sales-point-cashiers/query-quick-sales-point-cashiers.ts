...
@Component({
  selector: 'app-query-quick-sales-point-cashiers',
  imports: [NgClass, NgIf, NgFor, NgSelectComponent,RouterLink],
  templateUrl: './query-quick-sales-point-cashiers.html',
  styleUrl: './query-quick-sales-point-cashiers.scss',
})
export class QueryQuickSalesPointCashiers {
