...
@Component({
  selector: 'app-add-display-sales-prices',
  imports: [PageHeader, NgSelectComponent, DatePicker, Dialog],
  templateUrl: './add-display-sales-prices.html',
  styleUrl: './add-display-sales-prices.scss',
})
export class AddDisplaySalesPrices {
...
explorerBtn={
  label:'عرض اسعار المبيعات',
  link:'/display-sales-prices/add'
}
