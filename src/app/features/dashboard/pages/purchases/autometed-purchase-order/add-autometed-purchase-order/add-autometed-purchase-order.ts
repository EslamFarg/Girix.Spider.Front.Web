...
@Component({
  selector: 'app-add-autometed-purchase-order',
  imports: [PageHeader, DatePickerModule, NgSelectComponent],
  templateUrl: './add-autometed-purchase-order.html',
  styleUrl: './add-autometed-purchase-order.scss',
})
export class AddAutometedPurchaseOrder {
...
explorerBtn={
  ...
  link:'/autometed-purchase-order/explorer'
}
