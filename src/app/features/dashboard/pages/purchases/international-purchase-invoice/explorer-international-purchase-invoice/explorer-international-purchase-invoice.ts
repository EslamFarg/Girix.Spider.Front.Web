...
@Component({
  selector: 'app-explorer-international-purchase-invoice',
  imports: [Paginator, PageHeaderSearch],
  templateUrl: './explorer-international-purchase-invoice.html',
  styleUrl: './explorer-international-purchase-invoice.scss',
})
export class ExplorerInternationalPurchaseInvoice {
   //!!!!!!!!!! Property 
  dataAddButton={
      label:'اضافه فاتورة شراء جديد',
      action:'/international-purchase-invoice/add'
   }
