...
@Component({
  selector: 'app-explorer-inventory-adjustment-request',
  imports: [Paginator, PageHeaderSearch],
  templateUrl: './explorer-inventory-adjustment-request.html',
  styleUrl: './explorer-inventory-adjustment-request.scss',
})
export class ExplorerInventoryAdjustmentRequest {
  dataAddButton={
      label:'طلب تسوية المخزون ',
      action:'/inventory-adjustment-request/add'
   }
     first: number = 0;
   rows: number = 10;
