...
@Component({
  selector: 'app-explorer-opening-balance',
  imports: [Paginator, PageHeaderSearch],
  templateUrl: './explorer-opening-balance.html',
  styleUrl: './explorer-opening-balance.scss',
})
export class ExplorerOpeningBalance {
     dataAddButton={
      label:' الارصده الافتتاحيه ',
      action:'/opening-balance/add'
   }
     first: number = 0;
   rows: number = 10;
