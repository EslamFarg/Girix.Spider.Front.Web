...
@Component({
  selector: 'app-add-supply-order',
  imports: [PageHeader, NgSelectComponent, DatePicker, Dialog],
  templateUrl: './add-supply-order.html',
  styleUrl: './add-supply-order.scss',
})
export class AddSupplyOrder {
...
explorerBtn={
  label:'مستكشف أمر شراء',
  link:'/supply-order/explorer'
}
