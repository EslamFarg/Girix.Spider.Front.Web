...
@Component({
  selector: 'app-explorer-supply-order',
  imports: [PageHeaderSearch, Paginator],
  templateUrl: './explorer-supply-order.html',
  styleUrl: './explorer-supply-order.scss',
})
export class ExplorerSupplyOrder {
     dataAddButton={
      label:' اضافة امر شراء جديد ',
      action:'/supply-order/add'
   }
     first: number = 0;
   rows: number = 10;
