...
@Component({
  selector: 'app-add-periodic-inventory-warehouse',
  imports: [PageHeader, DatePicker, NgSelectComponent],
  templateUrl: './add-periodic-inventory-warehouse.html',
  styleUrl: './add-periodic-inventory-warehouse.scss',
})
export class AddPeriodicInventoryWarehouse {
...
explorerBtn={
  label:'مستكشف بيانات الجرد الدوري للمخازن ',
  link:'/periodic-inventory-warehouse/explorer'
}
