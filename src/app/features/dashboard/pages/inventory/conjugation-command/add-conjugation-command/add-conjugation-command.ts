...
@Component({
  selector: 'app-add-conjugation-command',
  imports: [PageHeader, NgSelectComponent, DatePicker],
  templateUrl: './add-conjugation-command.html',
  styleUrl: './add-conjugation-command.scss',
})
export class AddConjugationCommand {
...
explorerBtn={
  label:'مستكشف أمر صرف',
  link:'/conjugation-command/explorer'
}
