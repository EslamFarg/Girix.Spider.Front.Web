...
@Component({
  selector: 'app-exlorer-conjugation-command',
  imports: [Paginator, PageHeaderSearch],
  templateUrl: './exlorer-conjugation-command.html',
  styleUrl: './exlorer-conjugation-command.scss',
})
export class ExlorerConjugationCommand {
       dataAddButton={
      label:'أضافة أمر صرف ',
      action:'/conjugation-command/add'
   }
     first: number = 0;
   rows: number = 10;
