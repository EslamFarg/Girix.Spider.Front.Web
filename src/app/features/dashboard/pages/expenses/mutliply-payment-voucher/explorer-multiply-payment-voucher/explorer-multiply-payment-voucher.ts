...
@Component({
  selector: 'app-explorer-multiply-payment-voucher',
  imports: [PageHeaderSearch, Paginator],
  templateUrl: './explorer-multiply-payment-voucher.html',
  styleUrl: './explorer-multiply-payment-voucher.scss',
})
export class ExplorerMultiplyPaymentVoucher {
  
   //!!!!!!!!!! Property 
  dataAddButton={
      label:'اضافه سند جديد',
      action:'/expenses/multiply-payment-voucher/add'
   }
