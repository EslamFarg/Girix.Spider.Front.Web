...
@Component({
  selector: 'app-add-multiply-payment-voucher',
  imports: [Dialog, NgSelectComponent, DatePicker,RouterLink],
  templateUrl: './add-multiply-payment-voucher.html',
  styleUrl: './add-multiply-payment-voucher.scss',
})
export class AddMultiplyPaymentVoucher {
...
explorerBtn={
  label:' مستكشف  سند قبض مبسط ',
  link:'/receivables/receipt-voucher/explorer'
}
