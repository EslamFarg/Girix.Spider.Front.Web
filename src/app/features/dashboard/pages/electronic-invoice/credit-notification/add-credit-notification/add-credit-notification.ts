...
@Component({
  selector: 'app-add-credit-notification',
  imports: [NgSelectComponent, PageHeader, DatePicker],
  templateUrl: './add-credit-notification.html',
  styleUrl: './add-credit-notification.scss',
})
export class AddCreditNotification {
   // !!!!!!!!!!!!!!!!! Services

  // !!!!!!!!!!!!!!!!!!! Properties
  date2: Date | undefined;
  showNotMatchingInvoice: boolean = false
showMatchingInvoice: boolean = false
 actions = [
...
explorerBtn={
  label:'مستكشف إشعار دائن',
  link:'/electronic-invoice/credit-notification/explorer'
}
...
save(){
  ...
  this.showNotMatchingInvoice=true;
}
