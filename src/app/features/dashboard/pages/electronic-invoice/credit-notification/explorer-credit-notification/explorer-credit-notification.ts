...
@Component({
  selector: 'app-explorer-credit-notification',
  imports: [Paginator, PageHeaderSearch],
  templateUrl: './explorer-credit-notification.html',
  styleUrl: './explorer-credit-notification.scss',
})
export class ExplorerCreditNotification {
    //!!!!!!!!!! Property 
  dataAddButton={
      label:'اضافه إشعار دائن',
      action:'/electronic-invoice/credit-notification/add'
   }
     first: number = 0;
   rows: number = 10;
