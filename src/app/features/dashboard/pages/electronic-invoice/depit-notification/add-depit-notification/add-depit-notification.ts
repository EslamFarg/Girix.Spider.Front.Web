...
@Component({
  selector: 'app-add-depit-notification',
  imports: [PageHeader, DatePicker, NgSelectComponent],
  templateUrl: './add-depit-notification.html',
  styleUrl: './add-depit-notification.scss',
})
export class AddDepitNotification {
    // !!!!!!!!!!!!!!!!! Services
...
explorerBtn={
  label:'مستكشف إشعار مدين',
  link:'/electronic-invoice/depit-notification/explorer'
}
