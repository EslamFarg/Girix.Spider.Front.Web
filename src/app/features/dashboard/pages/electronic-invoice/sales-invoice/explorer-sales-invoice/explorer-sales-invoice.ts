...
@Component({
  selector: 'app-explorer-sales-invoice',
  imports: [PageHeaderSearch, Paginator],
  templateUrl: './explorer-sales-invoice.html',
  styleUrl: './explorer-sales-invoice.scss',
})
export class ExplorerSalesInvoice {
  //!!!!!!!!!! Property 
  dataAddButton={
      label:'اضافه فاتورة مبيعات',
      action:'/electronic-invoice/electronic-sales-invoice/add'
   }
     first: number = 0;
   rows: number = 10;
