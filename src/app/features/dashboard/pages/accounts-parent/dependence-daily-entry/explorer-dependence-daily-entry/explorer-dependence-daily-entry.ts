...
@Component({
  selector: 'app-explorer-dependence-daily-entry',
  imports: [Paginator, PageHeaderSearch],
  templateUrl: './explorer-dependence-daily-entry.html',
  styleUrl: './explorer-dependence-daily-entry.scss',
})
export class ExplorerDependenceDailyEntry {
  //!!!!!!!!!! Property 
  dataAddButton={
      label:'اضافه قيد يومي',
      action:'/accounts-parent/dependence-daily-entry/add'
   }
