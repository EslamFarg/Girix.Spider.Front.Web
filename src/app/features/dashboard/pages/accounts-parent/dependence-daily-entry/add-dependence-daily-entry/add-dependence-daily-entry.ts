...
@Component({
  selector: 'app-add-dependence-daily-entry',
  imports: [PageHeader, NgSelectComponent, DatePicker, Dialog,RouterLink],
  templateUrl: './add-dependence-daily-entry.html',
  styleUrl: './add-dependence-daily-entry.scss',
})
export class AddDependenceDailyEntry {
...
explorerBtn={
  label:'مستكشف قيود يوميه',
  link:'/accounts-parent/dependence-daily-entry/explorer'
}
