...
@Component({
  selector: 'app-explorer-daily-entry',
  imports: [Paginator, PageHeaderSearch],
  templateUrl: './explorer-daily-entry.html',
  styleUrl: './explorer-daily-entry.scss',
})
export class ExplorerDailyEntry {
   //!!!!!!!!!! Property 
  dataAddButton={
      label:'اضافه قيد يومي',
      action:'/accounts-parent/daily-entry/add'
   }
