...
@Component({
  selector: 'app-explorer-incomming-checks',
  imports: [Paginator, PageHeaderSearch],
  templateUrl: './explorer-incomming-checks.html',
  styleUrl: './explorer-incomming-checks.scss',
})
export class ExplorerIncommingChecks {

   //!!!!!!!!!! Property 
  dataAddButton={
      label:'اضافه شيك جديد',
      action:'/accounts-parent/incomming-checks/add'
   }
