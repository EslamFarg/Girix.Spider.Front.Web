...
@Component({
  selector: 'app-add-multiply-receipt-voucher',
  imports: [RouterLink, DatePicker, NgSelectComponent, Dialog],
  templateUrl: './add-multiply-receipt-voucher.html',
  styleUrl: './add-multiply-receipt-voucher.scss',
})
export class AddMultiplyReceiptVoucher {
