...
@Component({
  selector: 'app-explorer-multiply-receipt-voucher',
  imports: [Paginator, PageHeaderSearch],
  templateUrl: './explorer-multiply-receipt-voucher.html',
  styleUrl: './explorer-multiply-receipt-voucher.scss',
})
export class ExplorerMultiplyReceiptVoucher {
  
   //!!!!!!!!!! Property 
  dataAddButton={
      label:'اضافه سند جديد',
      action:'/receivables/multiply-receipt-voucher/add'
   }
