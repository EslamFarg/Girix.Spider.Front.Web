...
@Component({
  selector: 'app-explorer-receipt-voucher',
  imports: [Paginator, PageHeaderSearch],
  templateUrl: './explorer-receipt-voucher.html',
  styleUrl: './explorer-receipt-voucher.scss',
})
export class ExplorerReceiptVoucher {
  
   //!!!!!!!!!! Property 
  dataAddButton={
      label:'اضافه سند جديد',
      action:'/receivables/receipt-voucher/add'
   }
