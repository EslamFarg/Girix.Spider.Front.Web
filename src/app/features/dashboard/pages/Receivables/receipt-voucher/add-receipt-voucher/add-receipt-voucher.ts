...
@Component({
  ...
  imports: [PageHeader, DatePicker, NgSelectComponent, Dialog,RouterLink],
  templateUrl: './add-receipt-voucher.html',
  styleUrl: './add-receipt-voucher.scss',
})
export class AddReceiptVoucher {
