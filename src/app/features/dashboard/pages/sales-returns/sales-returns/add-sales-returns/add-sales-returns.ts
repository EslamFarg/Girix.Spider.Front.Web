...
@Component({
  selector: 'app-add-sales-returns',
  imports: [PageHeader, DatePicker, NgSelectComponent, Dialog],
  templateUrl: './add-sales-returns.html',
  styleUrl: './add-sales-returns.scss',
})
export class AddSalesReturns {
...
explorerBtn={
  label:'مستكشف  مرتجعات  مبيعات ',
  link:'/sales-returns/explorer'
}
