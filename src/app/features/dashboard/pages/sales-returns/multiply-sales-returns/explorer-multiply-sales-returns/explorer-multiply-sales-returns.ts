...
@Component({
  selector: 'app-explorer-multiply-sales-returns',
  imports: [Paginator, PageHeaderSearch],
  templateUrl: './explorer-multiply-sales-returns.html',
  styleUrl: './explorer-multiply-sales-returns.scss',
})
export class ExplorerMultiplySalesReturns {
   //!!!!!!!!!! Property 
  dataAddButton={
      label:'اضافه مرتجعات مبيعات جديده',
      action:'/multiply-sales-returns/add'
   }
