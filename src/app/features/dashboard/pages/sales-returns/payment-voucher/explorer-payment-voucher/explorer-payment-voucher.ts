...
@Component({
  selector: 'app-explorer-payment-voucher',
  imports: [PageHeaderSearch, Paginator],
  templateUrl: './explorer-payment-voucher.html',
  styleUrl: './explorer-payment-voucher.scss',
})
export class ExplorerPaymentVoucher {
   //!!!!!!!!!! Property 
  dataAddButton={
      label:'اضافه سند صرف مرتجعات',
      action:'/payment-voucher/add'
   }
...
filteringData=[
  {label:'رقم الفاتورة',key:'returnsNumber',type:'text',value:'',class:'col-span-4',placeholder:'رقم الفاتورة'},
      ...
      {label:'اسم العميل',key:'supplier',type:'text',value:'' , class:'col-span-4',placeholder:'العميل'},
   ]
