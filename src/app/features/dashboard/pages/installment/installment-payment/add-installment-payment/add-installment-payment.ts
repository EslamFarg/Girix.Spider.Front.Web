...
@Component({
  ...
  imports: [NgSelectComponent, DatePicker, PageHeader],
  templateUrl: './add-installment-payment.html',
  styleUrl: './add-installment-payment.scss',
})
export class AddInstallmentPayment {
...
explorerBtn={
  label:'مستكشف  التقسيط  ',
  link:'/installment-payment/explorer'
}
