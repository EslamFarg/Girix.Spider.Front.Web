...
@Component({
  selector: 'app-add-installment-proof',
  imports: [DatePicker, PageHeader],
  templateUrl: './add-installment-proof.html',
  styleUrl: './add-installment-proof.scss',
})
export class AddInstallmentProof {
...
explorerBtn={
  label:'مستكشف  اثبات التقسيط  ',
  link:'/installment-proof/explorer'
}
