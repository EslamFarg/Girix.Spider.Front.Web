...
@Component({
  selector: 'app-explorer-installment-proof',
  imports: [Paginator, PageHeaderSearch],
  templateUrl: './explorer-installment-proof.html',
  styleUrl: './explorer-installment-proof.scss',
})
export class ExplorerInstallmentProof {

   //!!!!!!!!!! Property 
  dataAddButton={
      label:'اضافه اثبات التقسيط',
      action:'/installment-proof/add'
   }
     first: number = 0;
   rows: number = 10;
