...
@Component({
  selector: 'app-explorer-depreciations',
  imports: [Paginator, PageHeaderSearch],
  templateUrl: './explorer-depreciations.html',
  styleUrl: './explorer-depreciations.scss',
})
export class ExplorerDepreciations {
   //!!!!!!!!!! Property 
  dataAddButton={
      label:'اضافه الأهلاكات',
      action:'/depreciations/add'
   }
     first: number = 0;
   rows: number = 10;
