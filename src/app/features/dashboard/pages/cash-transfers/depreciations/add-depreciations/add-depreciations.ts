...
@Component({
  selector: 'app-add-depreciations',
  imports: [PageHeader, NgSelectComponent, DatePicker, Dialog],
  templateUrl: './add-depreciations.html',
  styleUrl: './add-depreciations.scss',
})
export class AddDepreciations {
...
explorerBtn={
  label:'مستكشف الأهلاكات ',
  link:'/depreciations/explorer'
}
