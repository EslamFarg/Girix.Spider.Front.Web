...
@Component({
  selector: 'app-explorer-outgoing-transfer-approve',
  imports: [PageHeaderSearch, Paginator],
  templateUrl: './explorer-outgoing-transfer-approve.html',
  styleUrl: './explorer-outgoing-transfer-approve.scss',
})
export class ExplorerOutgoingTransferApprove {

   //!!!!!!!!!! Property 
  dataAddButton={
      label:'اضافه تحويل نقدي',
      action:'/outgoing-transfer-approve/add'
   }
