...
@Component({
  selector: 'app-add-outgoing-transfer-approve',
  imports: [NgSelectComponent, PageHeader, DatePicker, Dialog,RouterLink],
  templateUrl: './add-outgoing-transfer-approve.html',
  styleUrl: './add-outgoing-transfer-approve.scss',
})
export class AddOutgoingTransferApprove {
...
explorerBtn={
  label:'مستكشف التحويلات النقديه الصادره ',
  link:'/outgoing-transfer-approve/explorer'
}
