...
@Component({
  selector: 'app-explorer-cash-transfer-between-two-branches',
  imports: [Paginator, PageHeaderSearch],
  templateUrl: './explorer-cash-transfer-between-two-branches.html',
  styleUrl: './explorer-cash-transfer-between-two-branches.scss',
})
export class ExplorerCashTransferBetweenTwoBranches {
    //!!!!!!!!!! Property 
  dataAddButton={
      label:'اضافه تحويلات النقدية',
      action:'/cash-transfer-between-two-branches/add'
   }
     first: number = 0;
   rows: number = 10;
