...
@Component({
  selector: 'app-explorer-outgoing-transfer',
  imports: [PageHeader, Paginator, PageHeaderSearch],
  templateUrl: './explorer-outgoing-transfer.html',
  styleUrl: './explorer-outgoing-transfer.scss',
})
export class ExplorerOutgoingTransfer {
  //!!!!!!!!!! Property 
  dataAddButton={
      label:'اضافه تحويل نقدي',
      action:'/outgoing-transfer/add'
   }
