...
@Component({
  selector: 'app-add-outgoing-transfer',
  imports: [NgSelectComponent, DatePicker, PageHeader, Dialog],
  templateUrl: './add-outgoing-transfer.html',
  styleUrl: './add-outgoing-transfer.scss',
})
export class AddOutgoingTransfer {
...
explorerBtn={
  ...
  link:'/outgoing-transfer/explorer'
}
