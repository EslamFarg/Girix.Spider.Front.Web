...
@Component({
  selector: 'app-add-incomming-cash-transfer',
  imports: [RouterLink, DatePicker, NgSelectComponent, Dialog],
  templateUrl: './add-incomming-cash-transfer.html',
  styleUrl: './add-incomming-cash-transfer.scss',
})
export class AddIncommingCashTransfer {
...
explorerBtn={
  label:'مستكشف التحويلات النقديه  الواردة',
