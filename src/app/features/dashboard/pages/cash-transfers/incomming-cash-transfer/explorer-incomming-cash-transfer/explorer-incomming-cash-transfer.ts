...
@Component({
  selector: 'app-explorer-incomming-cash-transfer',
  imports: [Paginator, PageHeaderSearch],
  templateUrl: './explorer-incomming-cash-transfer.html',
  styleUrl: './explorer-incomming-cash-transfer.scss',
})
export class ExplorerIncommingCashTransfer {
  
   //!!!!!!!!!! Property 
  dataAddButton={
      label:'اضافه تحويل نقدي',
      action:'/incomming-cash-transfer/add'
   }
