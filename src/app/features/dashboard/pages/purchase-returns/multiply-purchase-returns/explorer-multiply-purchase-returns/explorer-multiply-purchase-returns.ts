...
@Component({
  selector: 'app-explorer-multiply-purchase-returns',
  imports: [Paginator, PageHeaderSearch],
  templateUrl: './explorer-multiply-purchase-returns.html',
  styleUrl: './explorer-multiply-purchase-returns.scss',
})
export class ExplorerMultiplyPurchaseReturns {
   //!!!!!!!!!! Property 
  dataAddButton={
