...
@Component({
  selector: 'app-add-multiply-purchase-returns',
  imports: [PageHeader, DatePicker, NgSelectComponent, Dialog],
  templateUrl: './add-multiply-purchase-returns.html',
  styleUrl: './add-multiply-purchase-returns.scss',
})
export class AddMultiplyPurchaseReturns {
...
explorerBtn={
  ...
  link:'/multiply-purchase-returns/explorer'
}
