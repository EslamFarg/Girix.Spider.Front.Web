...
@Component({
  selector: 'app-add-purchase-returns-without-invoice-number',
  imports: [PageHeader, NgSelectComponent, DatePicker, Dialog],
  templateUrl: './add-purchase-returns-without-invoice-number.html',
  styleUrl: './add-purchase-returns-without-invoice-number.scss',
})
export class AddPurchaseReturnsWithoutInvoiceNumber {
...
explorerBtn={
  ...
  link:'/purchase-returns-without-invoice-number/explorer'
}
