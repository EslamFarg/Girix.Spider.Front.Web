...
@Component({
  selector: 'app-explorer-purchase-returns-without-invoice-number',
  imports: [PageHeaderSearch, Paginator],
  templateUrl: './explorer-purchase-returns-without-invoice-number.html',
  styleUrl: './explorer-purchase-returns-without-invoice-number.scss',
})
export class ExplorerPurchaseReturnsWithoutInvoiceNumber {
    //!!!!!!!!!! Property 
  dataAddButton={
      label:'اضافه مرتجعات مشتريات جديده',
      action:'/purchase-returns-without-invoice-number/add'
   }
