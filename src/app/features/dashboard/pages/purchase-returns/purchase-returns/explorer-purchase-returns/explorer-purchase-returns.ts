...
@Component({
  selector: 'app-explorer-purchase-returns',
  imports: [Paginator, PageHeaderSearch],
  templateUrl: './explorer-purchase-returns.html',
  styleUrl: './explorer-purchase-returns.scss',
})
export class ExplorerPurchaseReturns {
   //!!!!!!!!!! Property 
  dataAddButton={
      label:'اضافه مرتجعات مشتريات جديده',
      action:'/purchase-returns/add'
   }
