...
import { IVatReportRow } from '../../../types/api/reports-types';
...
export class VatReport extends BaseComponent {
  ...
  search(pageIndex: number) {
    ...
    this.reportsService.getVatReport({ ...v, pageIndex, pageSize: 10 }).subscribe({
      next: (res) => {
