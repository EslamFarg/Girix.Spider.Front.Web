...
import { IGroupedTrialBalanceRow } from '../../../types/api/reports-types';

@Component({
  selector: 'app-grouped-trial-balance',
  ...
  templateUrl: './grouped-trial-balance.html',
  styleUrl: './grouped-trial-balance.css',
})
export class GroupedTrialBalance extends BaseComponent {
  ...
  search(pageIndex: number) {
    ...
    this.reportsService.getGroupedTrialBalance({ ...v, pageIndex, pageSize: 10 }).subscribe({
      next: (res) => {
