...
@Component({
  ...
  styleUrl: './supplier-statement.css',
})
export class SupplierStatement extends BaseComponent {
  ...
  search(pageIndex: number) {
    ...
    this.reportsService.getSupplierStatement({ ...v, pageIndex, pageSize: 10 }).subscribe({
      next: (res) => {
