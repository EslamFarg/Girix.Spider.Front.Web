...
import { IAccountMovementRow } from '../../../types/api/reports-types';
...
export class AccountMovement extends BaseComponent {
  ...
  rows = signal<IAccountMovementRow[]>([]);
  ...
  search(pageIndex: number) {
    ...
    this.reportsService.getAccountMovement({ ...v, pageIndex, pageSize: 10 }).subscribe({
      next: (res) => {
