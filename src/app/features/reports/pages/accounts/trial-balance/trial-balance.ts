...
import { ITrialBalanceRow } from '../../../types/api/reports-types';
...
export class TrialBalance extends BaseComponent {
  ...
  search(pageIndex: number) {
    ...
    this.reportsService.getTrialBalance({ ...v, pageIndex, pageSize: 10 }).subscribe({
      next: (res) => {
