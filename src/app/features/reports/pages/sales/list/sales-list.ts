...
import { ISalesReportRow } from '../../../types/api/reports-types';
...
export class SalesList extends BaseComponent {
  ...
  fg = this.fb.group({
    ...
    customerId: this.fb.control<number | null>(0),
  });
  ...
  search(pageIndex: number) {
    ...
    this.reportsService.getSalesList({ ...v, pageIndex, pageSize: 10 }).subscribe({
      next: (res) => {
